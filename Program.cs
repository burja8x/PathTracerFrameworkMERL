...
namespace PathTracer
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //        if (x < n)
            //        {
            //            brdf[x] = brdf[x] * RED_SCALE;
            //        }
            //        else if (x < n * 2 && x > n)
            //        {
            //            brdf[x] = brdf[x] * GREEN_SCALE;
            //        }
            //        else {
            //            brdf[x] = brdf[x] * BLUE_SCALE;
            //        }
        ...
        static (double, double, double) lookup_brdf_val(double[] brdf, double theta_in, double fi_in, double theta_out, double fi_out)
        {
            ...
            //Console.WriteLine(ind + BRDF_SAMPLING_RES_THETA_H * BRDF_SAMPLING_RES_THETA_D * BRDF_SAMPLING_RES_PHI_D / 2);
            //Console.WriteLine(ind + BRDF_SAMPLING_RES_THETA_H * BRDF_SAMPLING_RES_THETA_D * BRDF_SAMPLING_RES_PHI_D);
        ...
        static (double, double, double, double) std_coords_to_half_diff_coords(double theta_in, double fi_in, double theta_out, double fi_out)
        {
            ...
            double fi_half = Math.Atan2(half[1], half[0]);
